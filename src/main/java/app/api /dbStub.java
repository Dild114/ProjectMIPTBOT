...
import app.api.repository.MockUserRepository; 

import java.util.ArrayList;
import java.util.List;

public class dbStub implements ArticleRepository, CategoryRepository, SiteRepository, UserRepository {
    ...
    public void deleteSiteById(SiteId id, UserId userId) {
        sites.removeIf(site -> site.id().equals(id) && site.userId().equals(userId));
    }
